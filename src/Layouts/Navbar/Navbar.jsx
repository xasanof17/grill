        ...
        <div className="container">
          <div className="header-nav_content">
            ...
            <div className="header-nav_content-block">
              <div
                className="header-nav_content-block_search"
                onFocus={Focused}
              >
                <form
                  action=""
                  className="header-nav_content-block_search-form"
                >
                  <button className="header-nav_content-block_search-form_location">
                    <GrLocation />
                  </button>
                  <Input
                    type="search"
                  ...
                  <button
                    type="submit"
                    className="header-nav_content-block_search-form_search"
                  >
                    <BiSearch />
                  </button>
                </form>
                <div
                  className={
                    showSearch
                      ? "header-nav_content-block_search-list showsearch"
                      : "header-nav_content-block_search-list"
                  }
                >
                  <ul>
                    <li>
